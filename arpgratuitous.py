...
def help():
    print("The command takes 3 arguments:")
    print("interface sender_mac sender_ip\n")
    print("sender_mac = MAC address of the device that has the ip we're sending")
    print("sender_ip = The IP address that will be broadcasted")
    print("example: arpgratuitous.py eth0 00-0c-30-65-a2-1f 10.1.1.1")
    print("Tell everyone in the LAN that 10.1.1.1 is at 00-0c-30-65-a2-1f")
...
sender_mac_hex = mac_to_hex(sender_mac)
sender_ip_hex = ip_to_hex(sender_ip)
